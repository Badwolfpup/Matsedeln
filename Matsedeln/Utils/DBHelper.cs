        ...
        public static async Task<bool> AddGoodsToDB(Goods good)
        {
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(insertQuery, connect))
                {
                    ...
                    command.Parameters.AddWithValue("@GperDL", good.GperDL);
                    command.Parameters.AddWithValue("@GperST", good.GperST);
                    ...
                    using (var reader = await command.ExecuteReaderAsync())
                    {
                        ...
                        while (await reader.ReadAsync())
                        {
                            goods.Add(new Goods
                            {
                                ...
                                GperDL = reader.GetInt32(3),
                                GperST = reader.GetInt32(4)
                            });
                        }
                        return goods;
                    }
        ...
        public static async Task<bool> UpdateGoodsInDB(Goods nyVara)
        {
            ...
            try
            {
                ...
                using (var command = connect.CreateCommand())
                {
                    ...
                    command.Parameters.AddWithValue("@GperDL", nyVara.GperDL);
                    command.Parameters.AddWithValue("@GperST", nyVara.GperST);
